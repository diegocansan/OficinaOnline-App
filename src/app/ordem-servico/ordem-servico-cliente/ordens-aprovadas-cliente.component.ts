...
@Component({
  selector: 'oo-ordens-aprovadas-cliente',
  templateUrl: './ordem-servico-cliente-lista.component.html'
})

export class OrdensAprovadasClienteComponent implements OnInit {
  ordens: Ordem[] = []
  usuario:Usuario
  ...
  atualizar(){
    if(localStorage.getItem('currentUser') != null){
      ...
      this.ordemService.buscarOrdemCliente(this.usuario.cliente.id,1)
